  ...
  <div id="app">
    <div class="container">
      <ul class="nav nav-pills">
        ...
        <li role="presentation"><router-link to="/serviceLineList">勤务路线管理</router-link></li>
        <li role="presentation"><router-link :to="{path: '/roadlist', query: {serviceLineId: 0}}">路线管理</router-link></li>
